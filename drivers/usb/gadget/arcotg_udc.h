...
/* USBCONTROL Register Bit Masks */
#define  USBCTRL_ULPI_INT_EN                  (0x10000000)
#define  USBCTRL_OTG_WAKE_INT_EN              (0x08000000)
#define  USBCTRL_OTG_POWER_MASK               (0x01000000)
...
struct arcotg_udc {
	...
	int work_scheduled;
	atomic_t run_workqueue;
	struct delayed_work wakeup;
	atomic_t mA;
	enum usb_conn_sts conn_sts;
	int irq;
	atomic_t system_suspended;
