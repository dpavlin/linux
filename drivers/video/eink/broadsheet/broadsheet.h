...
#define BS_ROTMODE_0            0       // Rotation is counter clockwise:
#define BS_ROTMODE_90           1       //                                 1 -> portrait
#define BS_ROTMODE_180          2       //                                 2 -> landscape
#define BS_ROTMODE_270          3       //
...
//
extern void bs_sw_init_controller(bool full, bool orientation, u32 *xres_hw, u32 *xres_sw, u32 *yres);
...
extern u16 bs_read_temperature(void);
...
extern bool broadsheet_promote_flashing_updates(void);
