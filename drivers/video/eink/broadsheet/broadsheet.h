...
#define BS_UPD_MODE_GC4D        3       //  GC/GU @2bpp -> GC4D
#define BS_UPD_MODES_DARKER     2       // Darker:
#define BS_UPD_MODE_GC4         4       //  GC4 -> GC4D
...
#define BS_AUTO_WF_REG_GC4D     0x03A2  // Auto Waveform Mode Configuration Register GC4D [0, 5, 10, 15]
...
#define BS_AUTO_WF_MODE_GC4D    ((15 << 12) | (3 << 4) | BS_UPD_MODE_GC4D)
