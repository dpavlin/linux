...
EXPORT_SYMBOL(pmic_power_regulator_set_lp_mode); // LAB126 (for mxcfb module builds)
EXPORT_SYMBOL(pmic_power_regulator_get_lp_mode); // LAB126 (for mxcfb module builds)
					     ...
					     t_regulator_voltage voltage)
{
	...
	case SW_SW2A:
		...
		reg_val = BITFVAL(MC13783_SWSET_SW2A, voltage.sw2a);
	...
	case SW_SW2B:
		...
		reg_mask = BITFMASK(MC13783_SWSET_SW2B);
		reg = REG_SWITCHERS_3;
		break;
	case SW_SW3:
