...
#define CHRG_MSG_ERROR_BATT_READ_REG		"21", \
						"err=%d", \
						" Battery I2C register read failed\n"
...
#define CHRG_MSG_INFO_BATT_CALLBACK		"205", \
						"battery_error_flags=%d", \
...
#define CHRG_MSG_DBG_TEMP_AND_VBUS		"316" \
						" temp_ok=%d, vbus_present=%d battery_error_flags=%d :" \
