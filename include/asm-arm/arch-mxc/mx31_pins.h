...
typedef enum iomux_pins {
	...
	MX31_PIN_PWMO = _MXC_BUILD_NON_GPIO_PIN(81, 0, 108, 2),
#ifdef CONFIG_MACH_LAB126
	MX31_PIN_UART1_RTS = _MXC_BUILD_GPIO_PIN(1, 6, 28, 3, 39, 0),
	MX31_PIN_UART2_RXD = _MXC_BUILD_GPIO_PIN(0, 27, 26, 0, 35, 1),
	MX31_PIN_UART2_TXD = _MXC_BUILD_GPIO_PIN(0, 28, 25, 3, 35, 0),
#endif
} iomux_pin_name_t;
